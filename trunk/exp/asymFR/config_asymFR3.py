...
#              'WEATHER TERMS']
categories = ['TORONTO', 'BIRDS', 'BODY PARTS', 'BUILDING PARTS',
              'CAR MODELS', 'CARPENTRY TOOLS', 'CITIES', 'CLOTHES',
              'COLORS', 'COUNTRIES', 'DWELLINGS', 'ELEMENTS',
              'FABRICS', 'FISH', 'FOOTBALL TEAMS',
              'FOUR-FOOTED ANIMALS', 'FRUIT', 'FURNITURE',
              'GEOGRAPHY TERMS', 'INSECTS', 'INSTRUMENTS',
              'KITCHEN TOOLS', 'MUSIC STYLES', 'OCCUPATIONS',
              'READING MATERIALS', 'SEASONINGS', 'SHIPS', 'SPORTS',
              'STATES', 'TOYS', 'TREES', 'VEGETABLES',
              'WEATHER TERMS']
practCat = 0 # TORONTO
